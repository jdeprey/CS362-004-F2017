...
int smithy_card(struct gameState *state, int handPos, int currentPlayer) {
    int i;
    //+3 Cards
    for (i = 0; i <= 3; i++){
        drawCard(currentPlayer, state);
...
int great_hall_card(struct gameState *state, int handPos, int currentPlayer) {
    //+1 Card
    drawCard(currentPlayer, state);
...
int village_card(struct gameState *state, int handPos, int currentPlayer) {
    //+1 Card
    drawCard(currentPlayer, state);
...
int outpost_card(struct gameState *state, int handPos, int currentPlayer) {
    //set outpost flag
    state->outpostPlayed++;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case great_hall:
        great_hall_card(state, handPos, currentPlayer);
